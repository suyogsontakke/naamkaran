...
// RESTORED: Prayer Wheel with Spinning Text
const PrayerWheel = ({ x, y, delay }: { x: string, y: string, delay: number }) => (
    ...
    >
        <svg viewBox="0 0 120 160" className="w-full h-full drop-shadow-lg">
            ...
            {/* RESTORED: Spinning Text */}
            <g clipPath="url(#wheelClip)">
                 <motion.g
                    animate={{ x: [0, -180] }}
                    transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
                 >
                     <text x="10" y="78" fontSize="20" fill="#5c4033" fontWeight="bold" style={{fontFamily: 'serif'}}>नमो बुद्धाय</text>
                     <text x="190" y="78" fontSize="20" fill="#5c4033" fontWeight="bold" style={{fontFamily: 'serif'}}>नमो बुद्धाय</text>
                 </motion.g>
            </g>
...
// Optimized Buddha (Flat Gold = High Performance)
